...
export default function Whatsapp() {
    return (
        <Link
            ...
            target="_blank"
            className="fixed bottom-4 right-4 z-50 bg-primary hover:brightness-110 transition-all duration-300 rounded-full border-2 border-white animate-bounce z-[99999]"
        >
