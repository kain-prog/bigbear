            ...
            <section className="relative bg-[url('/banner-bigbear.jpg')] bg-cover">
                ...
                <div className="px-4 lg:px-8 max-w-screen-2xl mx-auto grid lg:grid-cols-2 gap-10 py-16">
                    <div className="flex flex-col gap-6 justify-center">
                        <h1 className="text-4xl md:text-7xl w-full font-bold leading-tight text-primary max-w-[580px]">
                            Seja bem-vindo a Big Bear
                        </h1>
                        <p className="mt-3 text-[#2a5457]">
                            Transforme sua ideia em peças profissionais <br /> com <span className="font-bold text-primary">design estratégico e marcas memoráveis.</span>
                        </p>
                        <div className="mt-5 flex flex-wrap items-center gap-3 z-[100]">
                            <Link
                                className="px-6 py-3 rounded-full text-white bg-primary font-semibold duration-150 transition-all hover:font-extrabold shadow-[0_8px_24px_rgba(4,207,198,.28)]"
                            ...
                            <Link
                                className="px-2 py-2 rounded-full bg-gradient-to-r from-[#F58529] via-[#DD2A7B] to-[#8134AF] text-white font-semibold text-lg"
